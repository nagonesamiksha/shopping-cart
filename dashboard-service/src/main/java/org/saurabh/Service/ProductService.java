...
//import org.saurabh.Entity.CategoryDataWithCount;
...
//
//    @Bean
//    public KTable<String, ProductDB> ProductKTable(StreamsBuilder streamsBuilder) {
//        KStream<String, ProductDB> productDataStream = streamsBuilder
//                .stream("ProductData", Consumed.with(Serdes.String(), Serdes.serdeFrom(ProductDB.class)));
...
//        ReadOnlyKeyValueStore<String, Categories> categoryDataStore = streams.store(StoreQueryParameters.fromNameAndType("CategoryDataStore", QueryableStoreTypes.keyValueStore()));
//
...
//    }
//
//    public List<ProductDB> getAllProductsWithCounts() {
//        KafkaStreams streams = streamsBuilderFactoryBean.getKafkaStreams();
//        ReadOnlyKeyValueStore<String, ProductDB> productDataStore = streams.store(StoreQueryParameters.fromNameAndType("ProductDataStore", QueryableStoreTypes.keyValueStore()));
...
//
//        List<ProductDB> productDataWithCount = new ArrayList<>();
//
//        productDataStore.all().forEachRemaining(entry -> {
//            ProductDB product = entry.value;
...
//            }
//        });
//        productDataWithCount.sort(Comparator.comparing(ProductDB::getViewCount).reversed());
//
//
//        return productDataWithCount;
//    }
//
//    public List<ProductDB> getFeaturedProducts(int n) {
...
//    }
//
//    public List<ProductDB> getLastViewedProducts(String userId) {
//        KafkaStreams streams = streamsBuilderFactoryBean.getKafkaStreams();
//        ReadOnlyKeyValueStore<String, ProductDB> recentlyViewedProductStore = streams.store(StoreQueryParameters.fromNameAndType("RecentlyViewedProductStore", QueryableStoreTypes.keyValueStore()));
//        List<ProductDB> list = new ArrayList<>();
//
//        KeyValueIterator<String, ProductDB> allProducts = recentlyViewedProductStore.all();
//        while (allProducts.hasNext()) {
//            KeyValue<String, ProductDB> keyValue = allProducts.next();
...
//                categoryProducts.sort(Comparator.comparingLong(ProductDB::getViewCount).reversed());
//
...
//        KafkaStreams streams = streamsBuilderFactoryBean.getKafkaStreams();
//        ReadOnlyKeyValueStore<String, ProductDB> userViewedProducts = streams.store(StoreQueryParameters.fromNameAndType("RecentlyViewedProductStore", QueryableStoreTypes.keyValueStore()));
//
//        // Query the store for the specified userId
//        ProductDB productDB = userViewedProducts.get(userId);
//
